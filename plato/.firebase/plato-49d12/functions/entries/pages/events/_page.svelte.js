import { o as set_current_component, r as run_all, p as current_component, q as is_function, t as get_store_value, u as noop, w as identity, c as create_ssr_component, i as getContext, k as subscribe, l as each, b as add_attribute, j as escape, v as validate_component, m as missing_component, g as get_current_component, s as setContext, x as add_styles, y as set_store_value, z as createEventDispatcher } from "../../../chunks/ssr.js";
...
const css = {
  code: "body.svelte-fqy6j5{margin:0;display:flex;justify-content:center;align-items:center;height:100vh}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<body class="svelte-fqy6j5"><div class="Calendar" style="position: absolute; top: 110px; width : 800px; display: flex; align-items: center;">${validate_component(Calendar, "Calendar").$$render($$result, { plugins, options }, {}, {})}</div> </body>`;
});
export {
  Page as default
};
