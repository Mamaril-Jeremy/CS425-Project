import { c as create_ssr_component, a as compute_rest_props, s as setContext, b as spread, e as escape_object, d as escape_attribute_value, f as add_attribute, g as getContext, h as escape, i as get_current_component, v as validate_component, j as compute_slots, k as validate_store, l as subscribe } from "../../chunks/ssr.js";
import { A as Avatar, P as Pfp } from "../../chunks/Mark Marsala.js";
...
const css = {
  code: ".navbar-container.s-mg88ejv8u490{position:fixed;top:0;left:0;right:0;z-index:1000}.plato.s-mg88ejv8u490{background:linear-gradient(rgb(80, 101, 168), rgb(78, 99, 166));;;-webkit-background-clip:text;background-clip:text;color:transparent}",
  map: null
};
const NavbarIn = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="navbar-container s-mg88ejv8u490">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/home" }, {}, {
        default: () => {
          return `<img${add_attribute("src", Logo, 0)} class="mr-3 w-14 first-line:sm:w-16" alt="Flowbite Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white"><span class="plato s-mg88ejv8u490" data-svelte-h="svelte-weyh89">Plato</span></span>`;
        }
      })} <div class="flex items-center md:order-2">${validate_component(Avatar, "Avatar").$$render($$result, { id: "avatar-menu", src: Pfp }, {}, {})} ${validate_component(NavHamburger, "NavHamburger").$$render(
        $$result,
        {
        ...
        {},
        {
          default: () => {
            return `${validate_component(DropdownHeader, "DropdownHeader").$$render($$result, {}, {}, {
              default: () => {
                return `<span class="block text-sm" data-svelte-h="svelte-1svmkqg">Mark Marsala</span> <span class="block truncate text-sm font-medium" data-svelte-h="svelte-pjepds">markymark@nevada.unr.edu</span>`;
              }
            ...
            })} ${validate_component(DropdownDivider, "DropdownDivider").$$render($$result, {}, {}, {})} ${validate_component(DropdownItem, "DropdownItem").$$render($$result, { href: "/home" }, {}, {
              default: () => {
                return `Sign out`;
              }
            })}`;
        ...
        default: () => {
          return `${validate_component(NavLi, "NavLi").$$render($$result, { href: "/home" }, {}, {
            default: () => {
              return `<span class="hover:text-blue-600" data-svelte-h="svelte-gej1pz">Home</span>`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/chat" }, {}, {
            default: () => {
              return `<span class="hover:text-blue-600" data-svelte-h="svelte-1oexuki">Chat</span>`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/connections" }, {}, {
            default: () => {
              return `<span class="hover:text-blue-600" data-svelte-h="svelte-xydnhf">Connections</span>`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/events" }, {}, {
            default: () => {
              return `<span class="hover:text-blue-600" data-svelte-h="svelte-1uav6t5">Events</span>`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/profile" }, {}, {
            default: () => {
              return `<span class="hover:text-blue-600" data-svelte-h="svelte-i4fqhf">Profile</span>`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/about" }, {}, {
            default: () => {
              return `<span class="hover:text-blue-600" data-svelte-h="svelte-166hz5n">About</span>`;
            }
          })}`;
        }
      })}`;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-da304h_START -->${$$result.title = `<title>Plato</title>`, ""}<link rel="icon" type="image/svg+xml"${add_attribute("href", Logo, 0)}><!-- HEAD_svelte-da304h_END -->`, ""} ${validate_component(NavbarIn, "NavbarIn").$$render($$result, {}, {}, {})} ${slots.default ? slots.default({}) : ``}`;
});
export {
  Layout as default
};
